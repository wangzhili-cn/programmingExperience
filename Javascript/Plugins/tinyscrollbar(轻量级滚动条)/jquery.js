...
+(function($){
	...
	*/
	 ...
	 * ====================================================
	*/
	$('body').append('<div class="modal hide fade" id="feed" tabindex="-1" style="width:400px;margin-left:-200px;"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h3>è®¢é˜…'+_deel.name+'</h3></div><div class="modal-body"><p><strong>è®¢é˜…åœ°å€</strong><br><input type="text" class="input-block-level" value="'+_deel.rss+'" readonly=""></p>'+(_deel.maillist?'<p><form class="subscribe-mail" action="http://list.qq.com/cgi-bin/qf_compose_send" target="_blank" method="post"><input type="hidden" name="t" value="qf_booked_feedback"><input type="hidden" name="id" value="'+_deel.maillistCode+'"><strong>é‚®ä»¶è®¢é˜…</strong><br><div class="form-inline clearfix"><input class="pull-left" style="width:300px;" id="to" name="to" type="email" placeholder="a@b.com"><input class="btn btn-primary pull-right" style="width:51px;" type="submit" value="è®¢é˜…"></div></form></p>':'')+'<p><strong>è®¢é˜…åˆ°</strong><br><a class="btn btn-mini btn-success" target="_blank" href="http://mail.qq.com/cgi-bin/feed?u=http://'+_deel.rss+'">QQé‚®ç®±</a> <a class="btn btn-mini btn-success" target="_blank" href="http://www.xianguo.com/subscribe.php?url=http://'+_deel.rss+'">é²œæžœ</a> <a class="btn btn-mini btn-success" target="_blank" href="http://mail.qq.com/cgi-bin/feed?u=http://'+_deel.rss+'">æŠ“è™¾</a></p></div></div><div class="rollto"><button class="btn btn-inverse" data-type="totop" title="å›žé¡¶éƒ¨"><i class="icon-eject icon-white"></i></button>'+(_deel.commenton?'<button class="btn btn-inverse" data-type="torespond" title="å‘è¯„è®º"><i class="icon-comment icon-white"></i></button>':'')+'</div>')
	...
	*/
	...
	var edit_mode = '0',
		txt1 = '<div class="comt-tip comt-loading">æ­£åœ¨æäº¤, è¯·ç¨å€™...</div>',
